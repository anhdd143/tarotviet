...
import greendream.ait.tarot.activity.ProfileActivity;
import greendream.ait.tarot.util.RecyclingBitmapDrawable;
...
public class ConfigData {
	...
	public static void loadSettingData(Activity a) {
		...
		if (rbdBackground == null) {
			rbdBackground = new RecyclingBitmapDrawable(
					appContext.getResources(), R.drawable.bg7,
					ConfigData.SCREEN_WIDTH, ConfigData.SCREEN_HEIGHT);
		}
